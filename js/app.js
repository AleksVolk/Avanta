    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".hero__container")) {
                const thumbsHero = new core(".thumbs-hero", {
                ...
                new core(".hero__slider", {
                    modules: [ Thumb, EffectFade, Keyboard ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    spaceBetween: 0,
            ...
            if (document.querySelector(".gym__slider")) new core(".gym__slider", {
                ...
                navigation: {
                    prevEl: ".gym__arrows .slider-arrow_prev",
                    nextEl: ".gym__arrows .slider-arrow_next"
                }
            });
            if (window.innerWidth < 991.98) if (document.querySelector(".team__slider")) new core(".team__slider", {
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                spaceBetween: 30,
            ...
            if (document.querySelector(".publications__slider")) new core(".publications__slider", {
                ...
                navigation: {
                    prevEl: ".publications__arrow_prev",
                    nextEl: ".publications__arrow_next"
                },
                breakpoints: {
                    320: {
                        spaceBetween: 30,
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                const targetElement = e.target;
                if (targetElement.classList.contains("video-cardio__btn")) {
